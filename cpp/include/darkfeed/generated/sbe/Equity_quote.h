...
#ifndef _DARKFEED_SCHEMAS_SBE_EQUITY_QUOTE_H_
#define _DARKFEED_SCHEMAS_SBE_EQUITY_QUOTE_H_
...
class Equity_quote {
 ...
 public:
    ...
    Equity_quote() : m_buffer(nullptr), m_bufferLength(0), m_offset(0)
    {}

    Equity_quote(char *buffer, const std::uint64_t bufferLength)
    {
        reset(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }

    Equity_quote(char *buffer, const std::uint64_t bufferLength, const std::uint64_t actingBlockLength, const std::uint64_t actingVersion)
    {
    ...
    Equity_quote &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        reset(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
        return *this;
    }

    Equity_quote &wrapForDecode(
...
#pragma clang diagnostic pop
    ...
    {
        return MIC::get((*((std::uint8_t *) (m_buffer + m_offset + 11))));
    }

    Equity_quote &reporting_exg(const MIC::Value value)
    {
        *((std::uint8_t *) (m_buffer + m_offset + 11)) = (value);
        return *this;
    }
...
#pragma clang diagnostic pop
 ...
 public:
    ...
    Timestamp &ts()
    {
        m_ts.wrap(m_buffer, m_offset + 12, m_actingVersion, m_bufferLength);
        return m_ts;
    }
...
#pragma clang diagnostic pop
    ...
    {
        return SBE_LITTLE_ENDIAN_ENCODE_64(*((std::uint64_t *) (m_buffer + m_offset + 26)));
    }

    Equity_quote &seq_num(const std::uint64_t value)
    {
        *((std::uint64_t *) (m_buffer + m_offset + 26)) = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        return *this;
    }
...
#pragma clang diagnostic pop
 ...
 public:
    ...
    Price &bid()
    {
        m_bid.wrap(m_buffer, m_offset + 34, m_actingVersion, m_bufferLength);
        return m_bid;
    }
...
#pragma clang diagnostic pop
 ...
 public:
    ...
    Price &ask()
    {
        m_ask.wrap(m_buffer, m_offset + 41, m_actingVersion, m_bufferLength);
        return m_ask;
    }
...
#pragma clang diagnostic pop
    ...
    {
        return SBE_LITTLE_ENDIAN_ENCODE_32(*((std::uint32_t *) (m_buffer + m_offset + 48)));
    }

    Equity_quote &bid_size(const std::uint32_t value)
    {
        *((std::uint32_t *) (m_buffer + m_offset + 48)) = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        return *this;
    }
...
#pragma clang diagnostic pop
    ...
    {
        return SBE_LITTLE_ENDIAN_ENCODE_32(*((std::uint32_t *) (m_buffer + m_offset + 52)));
    }

    Equity_quote &ask_size(const std::uint32_t value)
    {
        *((std::uint32_t *) (m_buffer + m_offset + 52)) = SBE_LITTLE_ENDIAN_ENCODE_32(value);
        return *this;
    }
...
#pragma clang diagnostic pop
    ...
    {
        return QuoteCondition::get((*((std::uint8_t *) (m_buffer + m_offset + 56))));
    }

    Equity_quote &condition(const QuoteCondition::Value value)
    {
        *((std::uint8_t *) (m_buffer + m_offset + 56)) = (value);
        return *this;
    }
