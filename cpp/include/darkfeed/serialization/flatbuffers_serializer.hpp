...
class FBSerializer {
 public:
    ...
    /// @note The header frame is a 32 bit (little-endian) unsigned integer length (not including the header) and a 32 bit CRC32C checksum (of the following message). This ensures 64 bit alignment of the subsequent message and provides integrity checking. If you need to access the message, it's offset by 8 bytes
    ...
    /// @brief Deserializes argument using appropriate flatbuffer schema. Assumes standard message framing.
